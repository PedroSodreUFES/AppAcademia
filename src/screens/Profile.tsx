...
export function Profile() {
    ...
    const [userPhoto, setUserPhoto] = useState("https:github.com/PedroSodreUFES.png")
    ...
    async function handleUserPhotoSelect() {
        try {
            ...
            // se o user não selecionar uma foto
            ...
            // pega a uri da foto e define como formato
            if (photoURI) {
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 36 }}>
                <Center mt="$6" px="$10">
                    ...
                    <Center w="$full" gap="$4">
                        ...
                        <Input value="pedrosodremalini@gmail.com" bg="$gray600" isReadOnly />
                    </Center>
